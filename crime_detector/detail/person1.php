            ...
            <div class="col-lg-4">
                <div class="card shadow-sm">
                    <div class="card-header bg-transparent text-center">
                        <img class="profile_img" src="../image/1.jpeg" alt="student dp">
                        <h3>Victor Chef</h3>
                    </div>
                    <div class="card-body">
                        <p class="mb-0"><strong class="pr-1">Identification Number:</strong>321000001</p>
                        <p class="mb-0"><strong class="pr-1">Crime:</strong>Gangster</p>
