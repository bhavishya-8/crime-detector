            ...
            <div class="col-lg-4">
                <div class="card shadow-sm">
                    <div class="card-header bg-transparent text-center">
                        <img class="profile_img" src="../image/6.jpeg" alt="student dp">
                        <h3>Ali Agca</h3>
                    </div>
                    <div class="card-body">
                        <p class="mb-0"><strong class="pr-1">Identification Number:</strong>321065401</p>
                        <p class="mb-0"><strong class="pr-1">Crime:</strong>Gangster</p>
                        <p class="mb-0"><strong class="pr-1">Place:</strong>Ahmedabad</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-8">
